...
- (void)viewDidLoad
{
    ...
    [self showContentControllerWithModel:_MainVC!=nil?NSStringFromClass([_MainVC class]):@"MilkDayViewController"];
...
{
    //恢复左视图到原始状态开始 ---liudonggan 20141215 add---
    [UIView beginAnimations:nil context:nil];
    self.changeLeftView(1, 0);
    [UIView commitAnimations];
    //恢复左视图到原始状态结束 ---liudonggan 20141215 add---
