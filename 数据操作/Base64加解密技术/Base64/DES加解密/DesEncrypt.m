...
{
    return [self encrypt:sText encryptOrDecrypt:kCCEncrypt key:@"w0hewodexiaohuobanmend0ujingdaile"];
}

+ (NSString *)decryptWithText:(NSString *)sText
{
    return [self encrypt:sText encryptOrDecrypt:kCCDecrypt key:@"w0hewodexiaohuobanmend0ujingdaile"];
}
