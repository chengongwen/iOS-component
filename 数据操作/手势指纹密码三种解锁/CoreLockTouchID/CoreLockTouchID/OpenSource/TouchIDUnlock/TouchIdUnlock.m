 ...
 */
- (void)startVerifyTouchIDWithSuccess:(void (^)(void))authSuccessBlock andFailure:(void (^)(NSError *))authFailureBlock {
                            ...
                            reply:^(BOOL success, NSError *error) {
                                if (success) {
                                    ...
                                    SmileTouchID_DispatchMainThread(^(){
                                        ...
                                        [self authenticatedSuccessfully:authSuccessBlock];
                                    });
...
/**
 指纹校验 成功
 */
- (void)authenticatedSuccessfully:(void (^)(void))authSuccessBlock
{
    NSLog(@"指纹校验成功");
