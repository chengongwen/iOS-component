 ...
 *  @param authailureBlock  块，当校验手势取消/密码失败之后，在主线程执行。
 */
- (void)startVerifyTouchIDWithSuccess:(void (^)(void))authSuccessBlock andFailure:(void (^)(NSError *error))authFailureBlock;
