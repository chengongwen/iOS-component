...
-(void)touchIDForINPUT_TOUCHID{
    [SmileAuthenticator sharedInstance].localizedReason = NSLocalizedString(@"SMILE_REASON", @"");
...
-(void)passwordWrong{
    ...
    self.descLabel.text = [NSString stringWithFormat:NSLocalizedString(@"SMILE_INPUT_FAILED %li count", nil), (long)_failCount];
}
