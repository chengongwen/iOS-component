...
#import "InitialSettingsCompanionViewController.h"
#import "RecordDiaryViewController.h"
...
- (BOOL)gestureRecognizerShouldBegin:(UIPanGestureRecognizer *)gestureRecognizer
{
    ...
    if ([vc isKindOfClass:[CompleteRegisterViewController class]]) {
        return NO;
    }
    if ([vc isKindOfClass:[InitialSettingsCompanionViewController class]]) {
        return NO;
    }
    if ([vc isKindOfClass:[RecordDiaryViewController class]]) {
        return NO;
    }
